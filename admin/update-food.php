    ...
    <div class="wrapper">
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                $price = $_POST['price'];
                $current_category = $_POST['current_image'];
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name !="")
                    {
                        ...
                        // 3. Remove the Image if New is Uploaded and Current Image Exist
                        ...
                        if($current_image != "")
                        {
                            ...
                            if($remove==false)
                            {
                                ...
                                $_SESSION['remove-dailed'] = "<div class='error'>Failed to Remove Current image.</div>";
                                // Redirect to manage Food
                                header("location:".SITEURL."admin/manage-food.php");
                                // Stop the Process
                                die();
                ...
                // Check wether the Query is Executedn or not
                if($res3 == true)
                {
                ...
                {
                    $_SESSION['update'] = "<div class='error'>Filed to Update Food.</div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                }
