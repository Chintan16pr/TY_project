        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="E.g. Chintan Prajapati" class="input-responsive" required>

                    <div class="order-label">Phone Number</div>
                    <input type="tel" name="contact" placeholder="E.g. 1234xxxxxx" class="input-responsive" required>

                    <div class="order-label">Email</div>
                    <input type="email" name="email" placeholder="E.g. hi@chintanOza     .com" class="input-responsive" required>
